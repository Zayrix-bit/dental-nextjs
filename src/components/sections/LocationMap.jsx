...
const MapPinIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-[16px] h-[16px] lg:w-[18px] lg:h-[18px] stroke-[var(--color-accent)]">
    ...
    <section className={`py-10 lg:py-16 bg-white ${className}`}>
      <div className="max-w-[1200px] mx-auto px-6 overflow-hidden">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 lg:mb-14">
          <h2 className="text-3xl md:text-4xl lg:text-[2.75rem] font-extrabold text-[var(--color-text-dark)] tracking-tight leading-[1.1]">
            Find Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-accent)]">Clinic.</span>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_350px] gap-6 lg:gap-8 items-stretch mx-auto max-w-[1000px]">
          ...
          <div className="w-full h-[300px] lg:h-[420px] rounded-2xl lg:rounded-3xl overflow-hidden shadow-sm hover:shadow-md border border-slate-100 bg-slate-50 relative group transition-shadow duration-300">
            {/* Overlay to prevent accidental scrolling on mobile until interacted, if desired. But standard iframe is fine. */}
            <iframe
          ...
          <div className="bg-white rounded-2xl lg:rounded-3xl p-6 lg:p-8 shadow-sm hover:shadow-md transition-all duration-300 border border-slate-100 flex flex-col h-full group hover:-translate-y-1">
            <h3 className="text-lg lg:text-xl font-bold text-[var(--color-text-dark)] mb-5 tracking-tight">
              Clinic Details
            </h3>
            ...
            <div className="flex flex-col gap-5 lg:gap-6 mb-8 flex-1">
              ...
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 lg:w-12 lg:h-12 rounded-xl bg-[rgba(79,195,247,0.1)] border border-[rgba(79,195,247,0.2)] flex items-center justify-center shrink-0">
                  <MapPinIcon />
                </div>
                <div>
                  <strong className="block textxs lg:text-[13px] font-extrabold text-[var(--color-text-dark)] tracking-wider uppercase mb-0.5">
                    Address
                  </strong>
                  <span className="text-[13px] lg:text-[14px] text-[var(--color-text-light)] leading-relaxed">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong className="block text-xs lg:text-[13px] font-extrabold text-[var(--color-text-dark)] tracking-wider uppercase mb-0.5">
                    Phone
                  </strong>
                  <span className="text-[13px] lg:text-[14px] text-[var(--color-text-light)]">
                    {siteInfo.phone}
                  </span>
                </div>
              </div>
